package com.davigj.guild_and_guile.client.renderer.entity;
...
public class PilferingHookRenderer extends EntityRenderer<PilferingHook> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("guild_and_guile:textures/entity/pilfering_hook.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutout(TEXTURE_LOCATION);
    private static final double VIEW_BOBBING_SCALE = 960.0D;

    public PilferingHookRenderer(EntityRendererProvider.Context p_174117_) {
        super(p_174117_);
    }

    public void render(PilferingHook p_114705_, float p_114706_, float p_114707_, PoseStack p_114708_, MultiBufferSource p_114709_, int p_114710_) {
        ...
        if (player != null) {
            ...
            // TODO: make it flip properly if in the offhand
            if (!itemstack.is(GAGItems.PILFERING_ROD.get())) {
                i = -i;
            }
    ...
    public ResourceLocation getTextureLocation(PilferingHook p_114703_) {
